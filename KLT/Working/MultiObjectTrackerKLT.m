...
%   Modified Sept 2018, added support for tracking with labels
%   Ross Kinard, Old Dominion University
%
%   Function can still be used as before without label
%   Still works with individual boxes or arrays
%   Label is passed as cell array of charachters
%   BoxLabels       - labels for each tracked box
%   Example usage:
%
...
classdef MultiObjectTrackerKLT < handle
    properties
        ...
        % BoxLabels cell array of character vectors for labels associated with each bounding box
        BoxLabels = [];
    ...
    methods(Access=private)        
        ...
        % Delete object.
            ...
            this.BoxLabels(this.BoxIds == boxIdx, :) = [];
        ...
        % Get bounding boxes for each object from tracked points.
            ...
            for i = 1:numBoxes
                ...
                this.BoxLabels = [this.BoxLabels; oldLabels(oldBoxIds == this.BoxIds(i))];
            end
